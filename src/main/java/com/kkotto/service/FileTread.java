...
public class FileTread extends Thread {
    ...
    public void run() {
        ...
        String currentTime = LocalDateTime.now().format(DateTimeFormatter.ofLocalizedDate(FormatStyle.SHORT));
        String outputString = String.format("%s - %s: %d", currentTime, threadName, ListUtils.findMaxListValue(listOfNumbers));
